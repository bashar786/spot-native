...
const PaymentDetailsScreen = () => {
  ...
  // Retrieve the activity details based on the ID
  ...
  // Split the amount into numerical value and currency code
  const [amountValue, currencyCode] = amount.split(' ');

  // Ensure FirstName and LastName are not empty before calling charAt
  ...
  return (
    <View style={{height: '100%'}}>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.container}>
          <Text style={{alignSelf: 'flex-start', marginTop: 0, fontSize: 27, color: Colors.dark, paddingBottom: 96}}>Payment Details</Text>
