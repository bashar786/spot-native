...
const ActivitiesScreen = () => {
  ...
  const sendActivities = activities.filter(activity => activity.type === 'receive');
  ...
  const renderItem = ({ item }) => {
    ...
    return (
      <TouchableOpacity style={{    paddingLeft: 2, paddingRight: 6}} onPress={() => navigation.navigate('RecieveDetails', { id: item.id })}>
