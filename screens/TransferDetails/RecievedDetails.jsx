  ...
  return (
    <View style={{ height: '100%' }}>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.container}>
          <Text style={{alignSelf: 'flex-start', marginTop: 0, fontSize: 27, color: Colors.dark, paddingBottom: 96}}>Receive Details</Text>
          <View style={styles.greyContainer}>
            ...
            <Text style={styles.sentToLabel}>Received from</Text>
...
export default RecieveDetailsScreen;
