  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View>
          <Text style={styles.infoText}>You're requesting money from</Text>
          ...
          <Text style={[styles.infoText, { fontSize: 12, paddingTop: 17 }]}>
            If this is correct, check the box to confirm, then tap <Text style={{fontFamily: 'Poppins-Bold'}}>Continue</Text>. Only use SPOT® to request money to people you know and trust.
          </Text>
      ...
      <View style={styles.buttonRow}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('RequestEnterAmount', { firstName, lastName, phoneNumber })}
        >
