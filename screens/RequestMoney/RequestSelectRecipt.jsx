...
const AdditionalScreen = () => {
  ...
  const handleDetails = useCallback((firstName, lastName, phoneNumber) => {
    navigation.navigate("RequestEnterAmount", { firstName, lastName, phoneNumber });
  }, [navigation]);
    ...
    <SafeAreaView style={styles.container}>
      <FlatList
        ...
        ListEmptyComponent={() => (
          <View style={styles.noResultsContainer}>
            ...
            {searchQuery.length > 0 && (
              <TouchableOpacity onPress={() => navigation.navigate('RequestAddReciept')}>
      ...
      {!isSearching && (
        <View style={styles.footerContainer}>
          <TouchableOpacity style={styles.footerButton} onPress={() => navigation.navigate('RequestPaymentMethod')}>
