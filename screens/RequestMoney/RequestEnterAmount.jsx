...
const AdditionalScreen = () => {
  ...
  const handleContinue = () => {
    ...
    navigation.navigate("RequestReviewAndSend", { phoneNumber: `${phoneNumber}`, firstName, lastName, inputValue: finalValue });
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.calculator}>
        ...
        <Text style={styles.limitText}>Your remaining daily recieve limit is <Text style={styles.limitBold}>{limit}</Text></Text>
