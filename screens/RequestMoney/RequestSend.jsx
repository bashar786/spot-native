      ...
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.content}>
          <View style={styles.buttonContainer}>
            <Text style={styles.headerText}>Request Send</Text>
          </View>
          ...
          <View>
            ...
            <Text style={{color: Colors.lightGreen, fontSize: 57, fontFamily: 'Poppins-Medium' , marginTop: 38, textAlign: 'center',}} >{inputValue}<Text style={{fontSize: 25}}>AED</Text> </Text>
                      
            <View style={{flexDirection: 'row', marginTop: 17, borderTopWidth: 1, borderBottomWidth: 1, gap: 20, borderColor: '#D7D7D7'}}>
