...
const AdditionalScreen = () => {
  ...
  const handleContinue = async () => {
    ...
    setTimeout(() => {
      ...
      navigation.navigate("DoubleCheckReciept", { phoneNumber: `+971 ${phoneNumber}`, firstName, lastName });
    }, 10);
  };
        ...
        {isButtonEnabled && (
          <View>
            <Text style={styles.receiptInfoText}>
              <Text style={styles.boldText}>{firstName} {lastName}</Text> must be enrolled with SPOT® using <Text style={styles.boldText}>+971 {phoneNumber}</Text> to receive money
            </Text>
            ...
            <Text style={styles.trustText}>Only use SPOT® to pay people you know and trust.</Text>
          </View>
        )}
      </ScrollView>
