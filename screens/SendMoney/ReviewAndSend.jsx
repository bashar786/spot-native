...
const AdditionalScreen = () => {
  ...
  const handleContinue = async () => {
    ...
    dispatch(addActivity({
      type: 'send', // You can customize this type
      amount: `${inputValue}`,
    ...
    setTimeout(() => {
      navigation.navigate("MoneySend", { phoneNumber: `${phoneNumber}`, firstName, lastName, inputValue });
    }, 10);
  };
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollViewContent}>
        <View style={styles.headerContainer}>
          <Text style={styles.headerText}>Review & Send</Text>
          </View>
        ...
        <View style={styles.content}>
          ...
          <View style={styles.detailsContainer}>
            ...
            <Text style={styles.infoText}>Your contact will get their money after they enroll with SPOT®</Text>
            <Pressable onPress={() => setModalVisible(true)}>
              <Text style={styles.aboutPaymentText}>About This Payment</Text>
            </Pressable>
          </View>
        </View>
      </ScrollView>
      ...
      <View style={styles.buttonView}>
        ...
        >
          <Text style={styles.reviewButtonText}>Send</Text>
        </TouchableOpacity>
      </View>
